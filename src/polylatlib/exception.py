...
class PolyLatNotCart(PolyLatError):
    """Raised when PolyLat expects a Cartesian coordinate and does not receive one."""
...
class PolyLatNotColour(PolyLatError):
    """Raised when PolyLat receives a non-supported colour for drawing purposes."""
...
class PolyLatNotProp(PolyLatError):
    """Raised when PolyLat receives an incorrect property."""
